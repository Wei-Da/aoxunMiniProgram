<template>
	<view class="container">
		...
		<!-- 页面弹窗 -->
		<u-modal title="温馨提示" show-cancel-button v-model="modalHidden" mask-close-able @confirm="modalChange" @cancel="cancleChange">
			<view style="text-align: center;">
				是否确认服务?
			</view>
		</u-modal>
		<u-modal title="温馨提示" show-cancel-button v-model="rejectModalHidden" mask-close-able @confirm="rejectModalChange"
		 @cancel="rejectCancleChange">
			<view style="text-align: center;">
				是否驳回服务?
			</view>
		</u-modal>
